...
if (EXISTS "${module_dir}/include/Enums.json")
  ...
  list(APPEND enums_json_output "${module_gen_dir}/Lxe${module_name}Enums.h")
...
if (EXISTS "${module_dir}/local_include/Enums.json")
  ...
  list(APPEND enums_json_output "${module_gen_dir}/local/Lxe${module_name}LocalEnums.h")
  set(has_enums_json TRUE)
endif()
if(has_enums_json)
  list(APPEND enums_json_output "${module_gen_dir}/local/Lxe${module_name}Enums.cpp")
endif()
